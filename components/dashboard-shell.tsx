...
export function DashboardShell({
  ...
  const navigation = role === "owner"
    ? [{ href: "/owner", label: "Overview" }, { href: "/owner/team", label: "Team" }, { href: "/owner/clients", label: "Clients" }, { href: "/owner/apps", label: "Apps & access" }, { href: "/owner/equipment", label: "Equipment" }, { href: "/owner/training-library", label: "Training library" }]
    : role === "coach"
